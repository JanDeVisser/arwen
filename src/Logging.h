...
#define trace(module, fmt, args...) Arwen::LogCategory(#module).trace_msg(__FILE__, __LINE__, __func__, fmt, ##args)
#define info(module, fmt, args...) Arwen::LogCategory(#module).info_msg(__FILE__, __LINE__, __func__, fmt, ##args)
#define warning(module, fmt, args...) Arwen::LogCategory(#module).warning_msg(__FILE__, __LINE__, __func__, fmt, ##args)
#define log_timestamp_start(module) (Arwen::LogCategory(#module).start())
#define log_timestamp_end(module, ts, fmt, ...) Arwen::LogCategory(#module).log_duration(ts, __FILE__, __LINE__, __func__, fmt, ##args)

#define log_error(fmt, args...) Arwen::Logger::get_logger().error_msg(__FILE__, __LINE__, __func__, fmt, ##args)
#define fatal(fmt, args...) Arwen::Logger::get_logger().fatal_msg( \
